...
const authenticate = (req: AuthRequest, res: Response, next: NextFunction): void => {
  try {
    ...
    const decoded = jwt.verify(token, JWT_SECRET) as { email: string; role: string; exp: number };
...
// Upload routes - SIMPLE version zonder Sharp dependency
...
app.get('/api/v1/admin/variants', authenticate, adminOnly, async (req: AuthRequest, res: Response) => {
  try {
...
// POST create variant
app.post('/api/v1/admin/variants', authenticate, adminOnly, async (req: AuthRequest, res: Response) => {
  try {
...
// PUT update variant
app.put('/api/v1/admin/variants/:id', authenticate, adminOnly, async (req: AuthRequest, res: Response) => {
  try {
...
// DELETE variant
app.delete('/api/v1/admin/variants/:id', authenticate, adminOnly, async (req: AuthRequest, res: Response) => {
  try {
    await prisma.productVariant.delete({
      where: { id: req.params.id },
    });
    res.json(success({ message: 'Variant deleted' }));
  } catch (err: any) {
...
// GET all returns
app.get('/api/v1/admin/returns', authenticate, adminOnly, async (req: AuthRequest, res: Response) => {
  try {
    ...
    res.json(success(returns.map((r: any) => ({
      ...r,
      refundAmount: r.refundAmount ? toNumber(r.refundAmount) : null,
    }))));
  } catch (err: any) {
    console.error('Returns error:', err);
    res.status(500).json(error('Could not fetch returns'));
  }
});

// GET return by ID
app.get('/api/v1/admin/returns/:id', authenticate, adminOnly, async (req: AuthRequest, res: Response) => {
  try {
    ...
    res.json(success({
      ...returnItem,
      refundAmount: returnItem.refundAmount ? toNumber(returnItem.refundAmount) : null,
    }));
  } catch (err: any) {
    console.error('Return by ID error:', err);
    res.status(500).json(error('Could not fetch return'));
  }
});

// PUT update return status
app.put('/api/v1/admin/returns/:id', authenticate, adminOnly, async (req: AuthRequest, res: Response) => {
  try {
...
app.post('/api/v1/admin/products', authenticate, adminOnly, async (req: AuthRequest, res: Response) => {
  try {
...
app.put('/api/v1/admin/products/:id', authenticate, adminOnly, async (req: AuthRequest, res: Response) => {
  try {
    const { categoryId, videoUrl, uspImage1, uspImage2, ...productData } = req.body;
...
app.delete('/api/v1/admin/products/:id', authenticate, adminOnly, async (req: AuthRequest, res: Response) => {
  try {
...
app.get('/api/v1/admin/products', authenticate, adminOnly, async (req: AuthRequest, res: Response) => {
  try {
    const products = await prisma.product.findMany({
      orderBy: { createdAt: 'desc' },
      include: {
...
app.get('/api/v1/admin/products/:id', authenticate, adminOnly, async (req: AuthRequest, res: Response) => {
  try {
    const product = await prisma.product.findUnique({
      where: { id: req.params.id },
      include: {
...
app.get('/api/v1/admin/orders', authenticate, adminOnly, async (req: AuthRequest, res: Response) => {
  try {
...
app.get('/api/v1/admin/orders/:id', authenticate, adminOnly, async (req: AuthRequest, res: Response) => {
  try {
...
app.put('/api/v1/admin/orders/:id', authenticate, adminOnly, async (req: AuthRequest, res: Response) => {
  try {
...
app.get('/api/v1/admin/categories', authenticate, adminOnly, async (req: AuthRequest, res: Response) => {
  try {
...
app.get('/api/v1/admin/categories/:id', authenticate, adminOnly, async (req: AuthRequest, res: Response) => {
  try {
...
app.post('/api/v1/admin/categories', authenticate, adminOnly, async (req: AuthRequest, res: Response) => {
  try {
...
app.put('/api/v1/admin/categories/:id', authenticate, adminOnly, async (req: AuthRequest, res: Response) => {
  try {
...
app.delete('/api/v1/admin/categories/:id', authenticate, adminOnly, async (req: AuthRequest, res: Response) => {
  try {
