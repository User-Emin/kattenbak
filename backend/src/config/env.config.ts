...
const envSchema = z.object({
  ...
  ADMIN_EMAIL: z.string().email().optional().default('admin@localhost'),
  ADMIN_PASSWORD: z.string().min(12, 'ADMIN_PASSWORD must be at least 12 characters').optional().default('admin123456789'),
