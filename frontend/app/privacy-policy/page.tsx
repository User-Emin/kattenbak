    ...
    <div className="container mx-auto px-4 py-16 max-w-4xl">
      ...
      <div className="prose prose-lg max-w-none space-y-6">
        ...
        <section>
          ...
          <p className="text-gray-700 leading-relaxed">
            Voor vragen over dit privacybeleid kunt u contact opnemen via: <a href="mailto:info@catsupply.nl" className="text-blue-600 hover:underline">info@catsupply.nl</a>
          </p>
        </section>
