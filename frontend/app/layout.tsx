  ...
  return (
    <html lang="nl" className={notoSansFont.variable}>
      <head>
        ...
        {/* ✅ SEO 10/10: Favicon & Icons – vierkant (32×32 / 16×16) */}
        ...
        <UIProvider>
          <CartProvider>
            <div className="flex flex-col min-h-screen">
              ...
              {/* MAIN CONTENT - ✅ ERROR BOUNDARY: Vangt alle errors op, toont altijd content */}
              <ErrorBoundary>
                <main 
                  className="flex-1 md:pb-0" // ✅ DESKTOP: Geen extra padding op desktop
                  style={{ 
