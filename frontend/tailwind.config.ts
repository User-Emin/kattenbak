  ...
  theme: {
    extend: {
      colors: {
        ...
        // Donkerblauw #334e6b voor navbar en structurele elementen  
        brand: {
          DEFAULT: '#334e6b',      // Donkerblauwe kleur
          light: '#4a6a8a',
          dark: '#243a52',
        },
        // Oranje #f25e02 voor cart/winkelwagen buttons
        cart: {
          DEFAULT: '#f25e02',      // Oranje voor cart buttons
          hover: '#d94d00',
          light: '#ff7020',
        },
      ...
      boxShadow: {
        ...
        'brand': '0 8px 32px rgba(51, 78, 107, 0.25)',  // #334e6b
        'brand-lg': '0 12px 48px rgba(51, 78, 107, 0.35)',
        'cart': '0 4px 16px rgba(242, 94, 2, 0.3)',  // #f25e02
        'cart-hover': '0 6px 24px rgba(242, 94, 2, 0.4)',
      },
    },
  },
  plugins: [],
