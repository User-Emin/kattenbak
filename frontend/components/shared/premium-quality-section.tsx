  ...
  return (
    <section 
      ...
      style={{
        ...
        backgroundColor: '#000000', // ✅ ZWART: Volledig zwart (was gradient)
      }}
    >
      ...
      >
          <h2 
            ...
            style={{
              ...
              color: '#FFFFFF', // ✅ WIT: Volledig wit (was text.inverse)
          ...
          <p 
            className="text-sm md:text-base lg:text-xl max-w-2xl mx-auto" // ✅ RESPONSIVE: Mobile kleiner (text-sm), Laptop kleiner (md:text-base ipv md:text-lg), Desktop groter, max-width voor 2 regels
            style={{
              fontWeight: DESIGN_SYSTEM.typography.fontWeight.normal,
              color: '#E5E5E5', // ✅ LICHTGRIJS: Voor contrast (was text.inverse)
