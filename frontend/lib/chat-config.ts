...
export const CHAT_CONFIG = {
  ...
  supportQuickReplies: {
    items: [
      ...
      { label: 'Veiligheid', value: 'Hoe werken de veiligheidssensoren precies?' },
      { label: 'App', value: 'Heeft het een app en hoe werkt die?' },
      { label: 'Geluidsniveau', value: 'Hoeveel lawaai maakt het?' },
